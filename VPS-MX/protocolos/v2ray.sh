...
# Activar soporte para expresiones regulares extendidas (necesario para la validación numérica +([0-9]))
shopt -s extglob

# --- VARIABLES DE COLOR (Asumo que estas ya existían, añado solo las de mensaje) ---
cor1='\033[41;1;37m'
cor2='\033[44;1;37m'
scor='\033[0m'
GREEN='\033[1;32m'
...
# --- VARIABLES DE MENSAJE (Añadidas/Verificadas para addusr) ---
...
# err_fun, msg y fun_trans deben estar definidas en tu entorno o script
    err_fun () {
        case $1 in
...
# ---------------------------------------------------------------------
# FUNCIÓN INTEGRADA: ADICIONAR USUARIO UUID (addusr)
# ---------------------------------------------------------------------
    addusr () {
        clear
        echo -e "\E[44;1;37m            ADICIONAR USUARIO | UUID V2RAY             \E[0m"

        ## CORREO (Generación de correo aleatorio)
        MAILITO=$(cat /dev/urandom | tr -dc '[:alnum:]' | head -c 10)

        ## UUID MANUAL O AUTOMÁTICO
        echo -e "\e[91m >> UUID automático o manual?"
        echo -e "\e[92m 1) Automático"
        echo -e "\e[92m 2) Manual"
        echo -ne "\e[91m >> Opción: \033[1;92m"
        read opc

        if [[ "$opc" = "2" ]]; then
            while true; do
                echo -ne "\e[91m >> Ingrese el UUID manual:\033[1;92m "
                read manual_uuid

                if [[ -z "$manual_uuid" ]]; then
                    echo -e "\e[91mEl UUID no puede estar vacío."
                    continue
                fi

                if [[ ! "$manual_uuid" =~ ^[0-9a-fA-F-]{36}$ ]]; then
                    echo -e "\e[91mFormato inválido. Debe ser un UUID válido."
                    continue
                fi
        ...
        ## AGREGAR EN CONFIG (/etc/v2ray/config.json)
        ...
        echo -e "\e[91m >> UUID utilizado: \e[92m$UUID"

        while true; do
            echo -ne "\e[91m >> Duração de UUID (Dias):\033[1;92m "
            read diasuser
        ...
        sed -i "11 s;%3A443;$nick;g" /etc/SSHPlus/v2ray/confuuid.log
...
# ---------------------------------------------------------------------
    ...
    fun_v2raymanager() {
		...
		do
			...
			echo -e "\033[0;34m┃\033[1;31m[\033[1;36m08\033[1;31m] \033[1;37m• \033[1;37mINFORMAÇÃO DA CONTA               \033[0;34m┃"
			echo -e "\033[0;34m┃\033[1;31m[\033[1;36m09\033[1;31m] \033[1;37m• \033[1;37mESTATÍSTICAS DE CONSUMO           \033[0;34m┃"
			echo -e "\033[0;34m┃\033[1;31m[\033[1;36m10\033[1;31m] \033[1;37m• \033[1;37mLIMITADOR POR CONSUMO               \033[0;34m┃"
			echo -e "\033[0;34m┃\033[1;31m[\033[1;36m11\033[1;31m] \033[1;37m• \033[1;37mLIMPADOR DE EXPIRADOS $statgen           \033[0;34m┃"
			echo -e "\033[0;34m┃\033[1;31m[\033[1;36m12\033[1;31m] \033[1;37m• \033[1;37mDESINSTALAR V2RAY                 \033[0;34m┃"
			echo -e "\033[0;34m┃\033[1;31m[\033[1;36m13\033[1;31m] \033[1;37m• \033[1;37mVOLTAR \033[1;32m<\033[1;33m<\033[1;31m<                        \033[0;34m┃"
			...
			4 | 04)
				...
				;;
			5 | 05)
				addusr # <--- NUEVA FUNCIÓN AGREGADA AQUÍ
				;;
			6 | 06)
				delusr
				;;
